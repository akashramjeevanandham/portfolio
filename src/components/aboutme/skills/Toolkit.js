...
import jp from "../../../images/Jupyter.png"
import msq from "../../../images/mysql.png"
    ...
    <div>
      ...
      <Container className="mt-4">
        <Row style={{ justifyContent: "center", paddingBottom: "50px" }}>
          ...
          <Col xs={4} md={2} className="tech-icons">
            <img src={jp} alt="" style={{ width: "85%", height: "85%" }} />
          </Col>
          <Col xs={4} md={2} className="tech-icons">
          ...
          <Col xs={4} md={2} className="tech-icons">
            <img src={msq} alt="" style={{ width: "85%", height: "85%" }} />
          </Col>
          <Col xs={4} md={2} className="tech-icons">
          ...
          <Col xs={4} md={2} className="tech-icons">
            <img src={netbeans} alt="" style={{ width: "95%", height: "95%" }} />
          </Col>
        </Row>
      </Container>
    </div>
